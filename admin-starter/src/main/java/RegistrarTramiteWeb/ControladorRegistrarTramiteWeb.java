...
public class ControladorRegistrarTramiteWeb {
    ...
    public int determinarConsultorATramite() {
        return expertoRegistrarTramiteWeb.determinarConsultorATramite();
    }
    
    public List<DTOTramite> obtenerListaDocumentacionTT(String nombreTipoTramite){
        return expertoRegistrarTramiteWeb.obtenerListaDocumentacionTT(nombreTipoTramite);
    }

    public TipoTramite obtenerTipoTramite(String nombreTipoTramite){
        return expertoRegistrarTramiteWeb.obtenerTipoTramite(nombreTipoTramite);
    }
    
    public Consultor obtenerConsultor(int nroLegajoConsultor){
        return expertoRegistrarTramiteWeb.obtenerConsultor(nroLegajoConsultor);
    }
    
    public Cliente obtenerCliente(int DNICli){
        return expertoRegistrarTramiteWeb.obtenerCliente(DNICli);
    }
    
    public EstadoTramite obtenerEstadoTramite(){
        return expertoRegistrarTramiteWeb.obtenerEstadoTramite();
    }
}
